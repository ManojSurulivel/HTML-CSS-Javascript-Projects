...
function declareWinner(winningTeam, margin, unit) {
  const scoreDisplay = document.getElementById("score-display");
  const winnerText = winningTeam === 1
    ? `Team 1 wins by ${margin} ${unit}!`
    : `Team 2 wins by ${margin} ${unit}!`;
...
document.addEventListener("DOMContentLoaded", () => {
  document.getElementById("button-1").onclick = () => addBallAndCheckWinner("1");
  document.getElementById("button-2").onclick = () => addBallAndCheckWinner("2");
  document.getElementById("button-3").onclick = () => addBallAndCheckWinner("3");
  document.getElementById("button-4").onclick = () => addBallAndCheckWinner("4");
  document.getElementById("button-5").onclick = () => addBallAndCheckWinner("5");
  document.getElementById("button-6").onclick = () => addBallAndCheckWinner("6");
  document.getElementById("button-dot").onclick = () => addBallAndCheckWinner("dot");
  document.getElementById("button-wicket").onclick = () => addBallAndCheckWinner("wicket");
  document.getElementById("button-wide").onclick = () => addExtraBallAndCheckWinner("wide");
  document.getElementById("button-no").onclick = () => addExtraBallAndCheckWinner("no");
});
